...
namespace PepyExtra\Widgets\ImageMask;
...
class Component extends Base {
	...
	public function get_name() {
		return 'pepy-el-image-mask';
	}

	public function get_title() {
		return __( 'Image Mask', 'pepy-addons-for-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'image_mask_heading',
			[
				'label' => __( 'Mask', 'pepy-addons-for-elementor' ),
		...
		$this->add_control(
			'image_mask',
			[
				'label' => __( 'Type', 'pepy-addons-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'style_1',
				'options' => [
					'style_1'  => __( 'Style 1', 'pepy-addons-for-elementor' ),
					'style_2' => __( 'Style 2', 'pepy-addons-for-elementor' ),
					'style_3' => __( 'Style 3', 'pepy-addons-for-elementor' ),
					'style_4' => __( 'Style 4', 'pepy-addons-for-elementor' ),
					'style_5' => __( 'Style 5', 'pepy-addons-for-elementor' ),
					'style_6' => __( 'Style 6', 'pepy-addons-for-elementor'),
					'style_7' => __( 'Style 7', 'pepy-addons-for-elementor'),
					'style_8' => __( 'Style 8', 'pepy-addons-for-elementor'),
					'none' => __( 'None', 'pepy-addons-for-elementor' ),
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .pepy-addons-for-elementor-imagemask' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		protected function render() {
			...
			$svg_id = 'pepy-addons-for-elementor-svg-' . $this->get_id();
			$image_id = 'pepy-addons-for-elementor-image-' . $this->get_id();
			?>
	
			<?php if ($settings['image_mask'] == 'style_1'){ ?>
				<svg id="<?php echo $svg_id; ?>" class="pepy-addons-for-elementor-imagemask" width="100%" height="100%" viewBox="0 0 606 364" preserveAspectRatio="xMidYMid slice">
					<defs>
			...
			<?php if ($settings['image_mask'] == 'style_3'){ ?>
				<svg id="<?php echo $svg_id; ?>" class="pepy-addons-for-elementor-imagemask"  width="100%" height="100%" viewBox="0 0 308 246" preserveAspectRatio="xMidYMid slice">
					<defs>
						<mask id="<?php echo $image_id; ?>" maskUnits="userSpaceOnUse" maskContentUnits="userSpaceOnUse" preserveAspectRatio="xMidYMid slice">
			...
			<?php if ($settings['image_mask'] == 'style_5'){ ?>
				<svg id="<?php echo $svg_id; ?>" class="pepy-addons-for-elementor-imagemask"  width="100%" height="100%" viewBox="0 0 307 246" preserveAspectRatio="xMidYMid slice">
					<defs>
						<mask id="<?php echo $image_id; ?>" maskUnits="userSpaceOnUse" maskContentUnits="userSpaceOnUse" preserveAspectRatio="xMidYMid slice">
			...
			<?php if ($settings['image_mask'] == 'style_6'){ ?>
				<svg id="<?php echo $svg_id; ?>" class="pepy-addons-for-elementor-imagemask" width="100%" height="100%" viewBox="0 0 1100.6 1209.8" preserveAspectRatio="xMidYMid slice">
					<mask id="<?php echo $image_id; ?>" maskUnits="userSpaceOnUse" maskContentUnits="userSpaceOnUse" preserveAspectRatio="xMidYMid slice">
			...
			<?php if ($settings['image_mask'] == 'style_7'){ ?>
				<svg id="<?php echo $svg_id; ?>" class="pepy-addons-for-elementor-imagemask" width="100%" height="100%" viewBox="0 0 1096.7 1224.4" preserveAspectRatio="xMidYMid slice">
					<mask id="<?php echo $image_id; ?>" maskUnits="userSpaceOnUse" maskContentUnits="userSpaceOnUse" preserveAspectRatio="xMidYMid slice">
			...
			<?php if ($settings['image_mask'] == 'style_8'){ ?>
				<svg id="<?php echo $svg_id; ?>" class="pepy-addons-for-elementor-imagemask" width="100%" height="100%" viewBox="0 0 1094.1 1142.1" preserveAspectRatio="xMidYMid slice">
					<mask id="<?php echo $image_id; ?>" maskUnits="userSpaceOnUse" maskContentUnits="userSpaceOnUse" preserveAspectRatio="xMidYMid slice">
						<g>
