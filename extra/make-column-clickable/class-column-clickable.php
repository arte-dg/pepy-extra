...
if ( ! class_exists( 'Make_Column_Clickable_Setup' ) ) :
  ...
  class Make_Column_Clickable_Setup {
    ...
    public function frontend_scripts() {
      wp_register_script( 'make-column-clickable-elementor', plugins_url( '/make-column-clickable/make-column-clickable.js', plugin_dir_path( __FILE__ ) ), array( 'jquery' ), Make_Column_Clickable_Elementor::VERSION, true );
    }
  }
