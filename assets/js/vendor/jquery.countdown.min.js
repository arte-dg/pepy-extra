!function () {
    ...
    window.JQClass = function () {
        ...
        t = !0;
        var s = new this;
        for (var o in t = !1, i) s[o] = "function" == typeof i[o] && "function" == typeof n[o] ? function (t, e) {
            return function () {
                var i = this._super;
    ...
    t.JQPlugin.createPlugin({
        ...
        _resetExtraLabels: function (t, e) {
            var i = !1;
            for (var n in e) if ("whichLabels" != n && n.match(/[Ll]abels/)) {
                i = !0;
                break
            }
        ...
        _adjustSettings: function (e, i, n) {
            for (var s, o = 0, a = null, r = 0; r < this._serverSyncs.length; r++) if (this._serverSyncs[r][0] == i.options.serverSync) {
                a = this._serverSyncs[r][1];
                break
            }
            if (null != a) o = i.options.serverSync ? a : 0, s = new Date; else {
        ...
        _determineTime: function (t, e) {
            var i, n, s = this, o = null == t ? e : "string" == typeof t ? function (t) {
                t = t.toLowerCase();
        ...
        _generateHTML: function (e) {
            ...
            for (var n = !1, s = 0, o = e.options.significant, a = t.extend({}, e._show), r = 0; r <= 6; r++) n |= "?" == e._show[r] && 0 < e._periods[r], a[r] = "?" != e._show[r] || n ? e._show[r] : null, s += a[r] ? 1 : 0, o -= 0 < e._periods[r] ? 1 : 0;
            var l = [!1, !1, !1, !1, !1, !1, !1];
            for (r = 6; 0 <= r; r--) e._show[r] && (e._periods[r] ? l[r] = !0 : (l[r] = 0 < o, o--));
            var p = e.options.compact ? e.options.compactLabels : e.options.labels,
                _ = e.options.whichLabels || this._normalLabels, h = e.options.padZeroes ? 2 : 1, u = function (t) {
                    var n = e.options["labels" + _(e._periods[t])];
                    return !e.options.significant && a[t] || e.options.significant && l[t] ? '<span class="' + i._sectionClass + '  section-'+ p[t].toLowerCase() +'"><span class="el_time-mid"><span class="' + i._amountClass + '">' + i._minDigits(e, e._periods[t], h) + '</span><span class="' + i._periodClass + '">' + (n ? n[t] : p[t]) + "</span></span><span class='el-countdown_separator'>" + e.options.timeSeparator + "</span></span>" : ""
                };
            return '<span class="' + this._rowClass + " " + this._showClass + (e.options.significant || s) + (e._hold ? " " + this._holdingClass : "") + '">' + u(0) + u(1) + u(2) + u(3) + u(4) + u(5) + u(6) + "</span>" + (e.options.description ? '<span class="' + this._rowClass + " " + this._descrClass + '">' + e.options.description + "</span>" : "")
        },
        _buildLayout: function (e, i, n, s, o, a) {
            for (var r = e.options[s ? "compactLabels" : "labels"], l = e.options.whichLabels || this._normalLabels, p = function (t) {
                ...
                var d = "yowdhms".charAt(c), m = new RegExp("\\{" + d + "<\\}([\\s\\S]*)\\{" + d + ">\\}", "g");
        ...
        _calculatePeriods: function (t, e, i, n) {
            ...
            var c = Math.floor((s.getTime() - n.getTime()) / 1e3), d = function (t, i) {
                o[t] = e[t] ? Math.floor(c / i) : 0, c -= o[t] * i
            };
            if (d(2, 604800), d(3, 86400), d(4, 3600), d(5, 60), d(6, 1), 0 < c && !t._since) for (var m = [1, 12, 4.3482, 7, 24, 60, 60], g = 6, f = 1, w = 6; 0 <= w; w--) e[w] && (o[g] >= f && (o[g] = 0, c = 1), 0 < c && (o[w]++, c = 0, g = w, f = 1)), f *= m[w];
